    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('productos.create') }}" method="POST" id="formCreateProductos">
                    @csrf
                    <div class="modal-body">
                        @csrf
                        <div class="row">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <input class="form-control @error('nombre_producto') is-invalid @enderror"
                                                type="text" name="nombre_producto"
                                                value="{{ old('nombre_producto') }}" placeholder="Nombre Producto">
                                        </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <input class="form-control @error('codigo_barras') is-invalid @enderror"
                                                type="text" name="codigo_barras" value="{{ old('codigo_barras') }}"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <input class="form-control @error('precio_venta') is-invalid @enderror"
                                                type="text" name="precio_venta" value="{{ old('precio_venta') }}"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="inventario" id="inventario"
                                                    value="1" placeholder="Inventario">
                                            </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <input class="form-control @error('alert_maxima') is-invalid @enderror"
                                                type="text" name="alert_maxima" value="{{ old('alert_maxima') }}" id="alerta_max"
                                                placeholder="Alerta Maxima">
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <select id="estatus" class="form-control selectpicker"
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <select id="proveedores_id" class="form-control selectpicker" name="proveedores_id"
                                ...
                                <div class="col-md">
                                    <div class="form-group mb-4">
                                        <label
                                            class="text-primary @error('inventario') border-danger text-danger @enderror">Categoria</label>
                                        <div class="input-group input-group-alternative">
                                            <span
                                                class="input-group-text @error('inventario') border-danger text-danger @enderror">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-braces-asterisk"
                                                    viewBox="0 0 16 16">
                                                    <path fill-rule="evenodd"
