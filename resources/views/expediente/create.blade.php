                        ...
                        <div class="card-body p-3" id="fase_uno">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" type="text" name="Nombre (S)" placeholder="nombre" id="nombre">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" type="date" id="fecha_nacimientoe"
                            ...
                            <div class="row">
                                <div class="col-md">
                                    ...
                                    <select class="js-example-responsive form-control" multiple="multiple" id="enfermedades_cronicas"
                                        style="width: 100%" name="enfermedades_cronicas">
                                ...
                                <div class="col-md">
                                    ...
                                    <select class="js-example-responsive form-control" multiple="multiple" id="enfermedades_mentales" name="enfermedades_mentales"
                                        style="width: 100%">
                            ...
                            <div class="row">
                                <div class="col-md">
                                    ...
                                    <select class="js-example-responsive form-control" multiple="multiple" id="uso_lentes"
                                        style="width: 100%" name="uso_lentes">
                                ...
                                <div class="col-md">
                                    <div class="row form-check">
                                        ...
                                        <select class="js-example-responsive form-control" multiple="multiple" id="mas_condiciones" name="mas_condiciones"
                                            style="width: 100%">
