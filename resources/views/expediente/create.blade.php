                            ...
                            <div class="row">
                                <div class="col-md">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" type="number" name="edad" id="edad"  min="0">
                                    </div>
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control" type="number" name="telefono" id="telefono" min="0" maxlength="10" title="Máximo 10 caracteres">
                                    </div>
