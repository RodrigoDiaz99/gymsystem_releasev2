...
!(function (t, e) {
    ...
    var qt = z,
        ...
        ee = function (t) {
            return (
                "Symbol(" + (void 0 === t ? "" : t) + ")_" + te(++Qt + Zt, 36)
            );
        },
        ie = Nt,
        ne = Jt,
        ...
        he = function (t) {
            return (
                ne(le, t) ||
                    (le[t] = re && ne(se, t) ? se[t] : ce("Symbol." + t)),
                le[t]
            );
        },
        ue = y,
            ...
            ? function (t, e, i) {
                  if (
                      ...
                      n &&
                          ...
                          (i = {
                              configurable:
                                  Qe in i ? i.configurable : n.configurable,
        ...
        en = (oi.exports = function (t, e, i) {
            "Symbol(" === Ji(Ki(e), 0, 7) &&
                ...
                (!Mi(t, "name") || (zi && t.name !== e)) &&
                    (Ui
                        ? Yi(t, "name", { value: e, configurable: !0 })
                        : (t.name = e)),
                Zi &&
                    i &&
                    Mi(i, "arity") &&
            ...
            return (
                Mi(n, "source") ||
                    (n.source = Qi(tn, "string" == typeof e ? e : "")),
                t
            );
        });
    ...
    pr.f =
        fr && !gr
            ...
            : function (t, e) {
                  br(t);
                  for (
                      var i, n = mr(e), o = yr(e), r = o.length, a = 0;
                      r > a;
        ...
        Er = function () {
            ...
            Er =
                "undefined" != typeof document
                    ? document.domain && wr
                        ? Rr(wr)
                        : (((e = Pr("iframe")).style.display = "none"),
                          Tr.appendChild(e),
                    ...
                    function (t, o) {
                        ...
                        for (var p = 0, f = 0, g = []; f < a.length; ) {
                            ...
                            if (
                                null === b ||
                                (v = Ls(
                                    Rs(u.lastIndex + (Vs ? f : 0)),
                                    a.length
                                )) === p
                            )
                                f = $s(a, f, c);
                            else {
                                if ((Us(g, zs(a, p, f)), g.length === d))
                                    return g;
    ...
    var Ws = g,
        ...
        Qs = function (t) {
            return function (e) {
                for (
                    var i, n = Ys(e), o = Ks(n), r = o.length, a = 0, s = [];
                    r > a;
    ...
    var Hc = kt,
        ...
        Wc = function (t, e) {
            ...
            return i < 8
                ? Gc(t, e)
                : Kc(t, Wc(zc(t, 0, n), e), Wc(zc(t, n), e), e);
        },
        Gc = function (t, e) {
            ...
            return [
                ...
                function (t, o) {
                    ...
                    for (var u = []; ; ) {
                        ...
                        if ((Jh(u, d), !c)) break;
                        "" === Lh(d[0]) &&
                            (r.lastIndex = Mh(a, Bh(r.lastIndex), h));
                    }
    ...
    xa("search", function (t, e, i) {
        return [
            ...
            function (t) {
                ...
                var s = hu(n, o);
                return (
                    su(n.lastIndex, a) || (n.lastIndex = a),
                    null === s ? -1 : s.index
                );
            },
        ];
    ...
    Pu in [] &&
        ...
        ku(
            { target: "Array", proto: !0, forced: Iu },
            {
        ...
        Du =
            ...
            ("__proto__" in {}
                ? (function () {
                      ...
                      return function (i, n) {
                          return (
                              Fu(i), Nu(n), e ? t(i, n) : (i.__proto__ = n), i
                          );
                      };
                  })()
                : void 0),
    ...
    [].keys &&
        ("next" in (pp = [].keys())
            ? (dp = Pp(Pp(pp))) !== Object.prototype && (up = dp)
            : ($p = !0));
    var Rp =
        !Tp(up) ||
        kp(function () {
    ...
    (Tg.prototype = mg),
        ...
        Zf(
            { global: !0, constructor: !0, wrap: !0, forced: kg },
            { Number: Tg }
        );
    kg &&
        (function (t, e) {
    ...
    zg(
        {
            ...
            forced:
                !!(
                    ev ||
                    ((Ug = Wg(String.prototype, "startsWith")),
                    !Ug || Ug.writable)
                ) && !ev,
        },
        {
    ...
    iv(
        { target: "String", proto: !0, forced: !fv && !pv },
        {
            endsWith: function (t) {
                var e = av(lv(this));
                sv(t);
                        ...
                        (l._id = s.attr("id")),
                            ...
                            s.find(">td,>th").each(function (o, a) {
                                ...
                                (l[f] = n.escapeApostrophe(s.html().trim())),
                                    ...
                                    (l["_".concat(f, "_class")] =
                                        s.attr("class")),
                                    (l["_".concat(f, "_rowspan")] =
                                        s.attr("rowspan")),
                                    (l["_".concat(f, "_colspan")] =
                                        s.attr("colspan")),
                                    (l["_".concat(f, "_title")] =
                                        s.attr("title")),
                                    (l["_".concat(f, "_data")] =
            ...
            return (
                o(n, [
                        ...
                        value: function () {
                            ...
                            (this.constants = Sv.CONSTANTS),
                                (this.constants.theme =
                                    t.fn.bootstrapTable.theme),
                                (this.constants.dataToggle =
                                    this.constants.html.dataToggle ||
                                    "data-toggle");
                            var n = gv.getIconsPrefix(
                                    t.fn.bootstrapTable.theme
                                ),
                                o = gv.getIcons(n);
                            "string" == typeof i.icons &&
                                (i.icons = gv.calculateObjectValue(
                                    null,
                                    i.icons
                                )),
                                (i.iconsPrefix =
                            ...
                            var r = i.buttonsPrefix
                                ? "".concat(i.buttonsPrefix, "-")
                                : "";
                            (this.constants.buttonsClass = [
                                i.buttonsPrefix,
                                r + i.buttonsClass,
                                gv.sprintf("".concat(r, "%s"), i.iconSize),
                            ]
                                .join(" ")
                                .trim()),
                                (this.buttons = gv.calculateObjectValue(
                                    this,
                                    i.buttons,
                                    [],
                                    {}
                                )),
                                "object" !== e(this.buttons) &&
                                    (this.buttons = {});
                        },
                    },
                    {
                            ...
                            if (
                                ...
                                this.$header.find("tr").each(function (n, o) {
                                    ...
                                    r.find("th").each(function (e, i) {
                                        ...
                                        for (var r in o)
                                            t.fn.bootstrapTable.columnDefaults.hasOwnProperty(
                                                r
                                            ) && delete o[r];
                                        a.push(
                                            gv.extend(
                                ...
                                (this.options.columns = gv.extend(
                                    !0,
                                    [],
                                    i,
                                    this.options.columns
                        ...
                        value: function () {
                            ...
                            (this.header = {
                                ...
                                this.options.columns.forEach(function (t, a) {
                                    ...
                                    if (
                                        0 === a &&
                                        gv.hasDetailViewIcon(i.options)
                                    ) {
                                        var c =
                                    ...
                                    l &&
                                        "right" !== i.options.detailViewAlign &&
                                        s.push(l),
                                        t.forEach(function (t, o) {
                                            var l = gv.sprintf(
                                                    ' class="%s"',
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            "append" === e
                                ...
                                : ((t = t || gv.deepCopy(this.options.data)),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            (this.options.sortName = t.field),
                                (this.options.sortOrder = t.hasOwnProperty(
                                    "sortOrder"
                                )
                                    ? t.sortOrder
                                    : "asc"),
                        ...
                        value: function () {
                                        ...
                                        html: function () {
                                            ...
                                            if (
                                                ...
                                                var e =
                                                    n.getVisibleColumns()
                                                        .length ===
                                                    n.columns.filter(function (
                                                        t
                                                    ) {
                                                        return !n.isSelectionColumn(
                                                            t
                                                        );
                                                    }).length;
                                                t.push(
                            ...
                            for (
                                ...
                                !(
                                    ...
                                    (void 0 !== k && !0 !== k) ||
                                    (o[O] = !0),
                                    o.buttonsOrder.includes(f) ||
                                        o.buttonsOrder.push(f);
                            }
                            var C,
                                T = c(o.buttonsOrder);
                            try {
                            ...
                            for (
                                var I = 0, A = Object.entries(this.buttons);
                                I < A.length;
                                I++
                            ) {
                                var $ = r(A[I], 2),
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    var q =
                                        (o.showSearchButton ? H : "") +
                                        (o.showSearchClearButton ? M : "");
                                    z = o.search
                                        ? gv.sprintf(
                        ...
                        value: function () {
                            ...
                            if (
                                ...
                                if (this.options.customSearch)
                                    return (
                                        (this.data = gv.calculateObjectValue(
                                            this.options,
                                ...
                                var e =
                                        this.searchText &&
                                        (this.fromHtml
                                            ? gv.escapeHTML(this.searchText)
                                            : this.searchText),
                                    i = e ? e.toLowerCase() : "",
                                    n = gv.isEmptyObject(this.filterColumns)
                                        ? null
                                        : this.filterColumns;
                                this.options.searchAccentNeutralise &&
                                    (i = gv.normalizeAccent(i)),
                                    "function" ==
                        ...
                        value: function () {
                            ...
                            if (e.pagination) {
                                ...
                                if (
                                    ...
                                    var p = this.paginationParts.includes(
                                        "pageInfoShort"
                                    )
                    ...
                    },
                    {
                        ...
                        value: function (t, i, n, o) {
                            ...
                            if (!(gv.findIndex(this.hiddenRows, t) > -1)) {
                                ...
                                var I = "";
                                return (
                                    gv.hasDetailViewIcon(this.options) &&
                                        ((I = "<td>"),
                                        gv.calculateObjectValue(
                                            null,
                                            this.options.detailFilter,
                    ...
                    },
                    {
                        ...
                        value: function (e, i) {
                            ...
                            this.trigger("pre-body", o),
                                ...
                                this.$body.length ||
                                    (this.$body = t("<tbody></tbody>").appendTo(
                                        this.$el
                                    )),
                                (this.options.pagination &&
                                    "server" !== this.options.sidePagination) ||
                            ...
                            var r = [],
                                ...
                                s = !1,
                                l = [];
                            this.autoMergeCells = gv.checkAutoMergeCells(
                        ...
                        value: function () {
                            ...
                            this.$body
                                    ...
                                    if (
                                        ...
                                        var o = n.parent(),
                                            r = t(i.target)
                                                .parents(".card-views")
                                                .children(),
                                            a = t(i.target).parents(
                                                ".card-view"
                                            ),
                                            s = o.data("index"),
                                            l = e.data[s],
                                            c = e.options.cardView
                                                ? r.index(a)
                                                : n[0].cellIndex,
                                            h =
                                                e.getVisibleFields()[
                                ...
                                .on("mousedown", function (t) {
                                    (e.multipleSelectRowCtrlKey =
                                        t.ctrlKey || t.metaKey),
                                        (e.multipleSelectRowShiftKey =
                                            t.shiftKey);
                                }),
                                this.$body
                                    .find(
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            for (
                                ...
                                s[l - 1] = arguments[l];
                            (i = this.options)[n.EVENTS[r]].apply(
                                i,
                                [].concat(s, [this])
                            ),
                                this.$el.trigger(
                                    t.Event(r, { sender: this }),
                                    s
                                ),
                                ...
                                this.$el.trigger(
                                    t.Event("all.bs.table", { sender: this }),
                                    [r, s]
                                );
                        },
                    },
                        ...
                        value: function () {
                            ...
                            if (this.$el.is(":hidden"))
                                ...
                                u.find("> *").each(function (i, n) {
                                    var o = t(n);
                                    if (
                                        gv.hasDetailViewIcon(e.options) &&
                                        ((0 === i &&
                                            "right" !==
                                                e.options.detailViewAlign) ||
                                            (i === d - 1 &&
                                                "right" ===
                                                    e.options.detailViewAlign))
                                    ) {
                        ...
                        value: function () {
                            ...
                            if (this.$el.is(":hidden"))
                                ...
                                for (
                                    ...
                                    r.length &&
                                    r.find('>td[colspan]:not([colspan="1"])')
                                        .length;
                    ...
                    },
                    {
                        key: "refreshOptions",
                        value: function (t) {
                            gv.compareObjects(this.options, t, !0) ||
                                ((this.options = gv.extend(this.options, t)),
                        ...
                        value: function (t) {
                            ...
                            if (
                                ((!(
                                    ...
                                    gv.isEmptyObject(this.filterColumns) &&
                                    "function" !=
                            ...
                            try {
                                for (i.s(); !(e = i.n()).done; ) {
                                    ...
                                    n.hasOwnProperty("index") &&
                                        ...
                                        (n.hasOwnProperty("replace") &&
                                        n.replace
                                            ? (this.options.data[n.index] =
                                                  n.row)
                                            : gv.extend(
                                                  this.options.data[n.index],
                                                  n.row
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    for (
                                        ...
                                        (this.data[u][this.header.stateField] =
                                            !0),
                                            this.$selectItem
                                                .filter(
                                                    '[data-index="'.concat(
                    ...
                    },
                    {
                        key: "filterBy",
                        value: function (t, e) {
                            (this.filterOptions = gv.isEmptyObject(e)
                                ? this.options.filterOptions
                                : gv.extend(this.options.filterOptions, e)),
                                (this.filterColumns = gv.isEmptyObject(t)
                                    ? {}
                                    : t),
                                (this.options.pageNumber = 1),
                                this.initSearch(),
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            this.$body
                                .find(gv.sprintf('> tr[data-index="%s"]', t))
                                .next()
                                .is("tr.detail-view")
                                ? this.collapseRow(t)
                                : this.expandRow(t, e),
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            e.hasOwnProperty("field") &&
                                ...
                                ((this.columns[
                                    this.fieldsColumnsIndex[e.field]
                                ].title =
                                    this.options.escape &&
                                    this.options.escapeTitle
                                        ? gv.escapeHTML(e.title)
                                        : e.title),
                                this.columns[this.fieldsColumnsIndex[e.field]]
                                    .visible &&
                                    (this.$header
                                        .find("th[data-field]")
                                        .each(function (i, n) {
                ...
                this.each(function (n, r) {
                    ...
                    if ("string" == typeof i) {
                        ...
                        return (
                            ...
                            void (
                                "destroy" === i &&
                                t(r).removeData("bootstrap.table")
                            )
                        );
                    }
                    if (s)
                        console.warn(
                            "You cannot initialize the table more than once!"
                        );
                    else {
                        var c = gv.extend(
                            !0,
